...
#SBATCH --job-name=methylome           # Job name to show with squeue
#SBATCH --output=methylome_%j.out      # Output file
...
#   methylome_submit.sh
#
#   This program generate normalize count tables of methylome
...
echo -e "Methylation normalization finish..."
