...
task_Methylation_extractor_paired_end(){
	...
	bismark_methylation_extractor --parallel 8 --paired-end --comprehensive --no_overlap --cytosine_report --bedGraph --CX $2/03-Deduplication/$1.trimmed.bismark_bt2_pe.deduplicated.bam --genome_folder $2/01-Genome_preparation/ --output $2/04-Methylation_extractor/$1/ >> $2/Logs/Methylation_extractor_$1\_stdout.log 2>&1
