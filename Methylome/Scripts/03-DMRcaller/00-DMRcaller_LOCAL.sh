...
#SBATCH --job-name=dmrL								# Job name.
#SBATCH --output=DMRs_prediction_LOCAL.log						# Standard output and error log.
...
####### PIPELINE
Rscript 00-DMRcaller.R $WD/Results/02-DMRcaller/LOCAL $WD/Results/01-Bismark/LOCAL/04-Methylation_extractor $WD/Additional_info/Summary_samples/summary_samples.tsv $SLURM_CPUS_PER_TASK
